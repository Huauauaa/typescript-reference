...
String enums are a similar concept, but have some subtle [runtime differences](l#enums-at-runtime) as documented below. In a string enum, each member has to be constant-initialized with a string literal, or with another string enum member.
